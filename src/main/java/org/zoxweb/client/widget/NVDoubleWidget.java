...
public class NVDoubleWidget
	extends NVBaseWidget<Double>
	implements KeyPressHandler
{
	...
	public NVDoubleWidget(NVConfig nvConfig)
	{
		...
		{
			textWidgetController = new NVTextWidgetController(doubleBox, FilterType.DOUBLE, this);
		}
	...
	@Override
	public void setWidgetValue(Double value) 
	{
	...
	public void onKeyPress(KeyPressEvent event) 
	{
		...
		if (!FilterType.DOUBLE.isValid(input))
		{
			doubleBox.cancelKey();
		}
	}
	...
	{
		setWidgetValue(Double.parseDouble(value));
	}
