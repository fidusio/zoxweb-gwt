	...
	implements CRUDNVBaseHandler, AttachEvent.Handler
{
	...
	private StringValueGetterComparator<NVPair> comparator;
	...
	public NVDynamicEnumWidget(String name, DynamicEnumMap dem, Const.NVDisplayProp displayProp, boolean isTitleAvailable, StringValueGetterComparator<NVPair> comparator)
	{
